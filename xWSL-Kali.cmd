...
%GO% "DEBIAN_FRONTEND=noninteractive apt-fast -y install kali-desktop-xfce ; dpkg --purge gvfs gvfs-backends gvfs-daemons gvfs-fuse udisks2 pcscd blueman bluez pulseaudio-module-bluetooth ; apt -y autoremove --purge" > "%TEMP%\xWSL-LOGS\%TIME:~0,2%%TIME:~3,2%%TIME:~6,2% Kali-Desktop-XFCE.log" 2>&1
